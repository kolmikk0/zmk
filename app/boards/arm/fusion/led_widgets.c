...
const led_widget_t led_widgets[][4] = {
    [LED_EVENT_BOOT] = {
    ...
    [LED_EVENT_BATTERY] = {
        ...
        WIDGET(100, priority = 50, period = 120000, cmd_len = 1, CMD(50, 0, 30, 0)),
    },
    [LED_EVENT_LAYER] = {
        WIDGET(1, priority = 20, period = 0, cmd_len = 1, CMD(0, 0, 0, 20)),
        WIDGET(2, priority = 20, period = 0, cmd_len = 1, CMD(0, 0, 20, 0)),
        WIDGET(3, priority = 20, period = 0, cmd_len = 1, CMD(0, 0, 0, 50)),
        WIDGET(4, priority = 20, period = 0, cmd_len = 1, CMD(0, 50, 0, 0)),
    },
    [LED_EVENT_OUTPUT] = {
